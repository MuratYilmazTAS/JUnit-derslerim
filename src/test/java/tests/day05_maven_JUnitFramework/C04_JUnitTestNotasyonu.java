...
public class C04_JUnitTestNotasyonu {
    ...
    @Test notasyonu siradan bir method'u tek basina calistirilabilir
    ...
    JUnit class icerisindeki test method'larini belirli belirsiz bir sirada calistirir.
    ...
    @Test
    public  void amazontTesti(){
        // amazona gidelim ve url'in amazon icerdigini test edip
        ...
        if (actualUrl.contains(expectedUrlIcerik)){
            System.out.println("Amazon url testi PASSSED");
        }else {
