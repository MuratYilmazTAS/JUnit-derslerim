...
public class C02_ReadExcel {
    ...
    public void test01() throws IOException {
       ...
       //  - Fiziki olarak kullanilan satir sayisini bulun
        System.out.println(sayfa1.getPhysicalNumberOfRows()); // 191 fiziki olarak kullanilan satiri bulur

        //Sayfa 2 icin son satir numarasi ve fiziki olarak kullanilan satir sayisini yazdirin
        Sheet sayfa2 = workbook.getSheet("Sayfa2");
        System.out.println("Son satir Index'i : " +sayfa2.getLastRowNum()); //23
        System.out.println("Fiziki olarak kullanilan satir sayisi : "+sayfa2.getPhysicalNumberOfRows()); // 8

       // Listede Togo olup olnadigini test edin
        boolean flag = false;
        ...
        // Listede Benin olup olnadigini test edin
        Assert.assertTrue(ulkelerMap.containsKey("Benin"));

        // Listede Ankara olup olnadigini test edin
