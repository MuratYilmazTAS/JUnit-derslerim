...
public class ReusableMethods {
    ...
    public static void tumSayfaFotoCek(WebDriver driver){
        ...
        LocalDateTime ldt = LocalDateTime.now(); // 2023-07-07T10:18:43.456
        DateTimeFormatter dtf = DateTimeFormatter.ofPattern("YYMMddhhmm");
        String dinamikDosyaYolu = "target/Screenshot/TumSayfa"+ldt.format(dtf)+".png";
    ...
    public static void webElementFotoCek(WebDriver driver, WebElement istenenWebElement) {
        ...
        LocalDateTime ldt = LocalDateTime.now(); // 2023-07-07T10:18:43.456
        DateTimeFormatter dtf = DateTimeFormatter.ofPattern("YYMMddhhmm");
        String dinamikDosyaYolu = "target/Screenshot/webElement"+ldt.format(dtf)+".png";
